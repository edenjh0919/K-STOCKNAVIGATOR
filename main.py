...
with top_col2:
    with st.popover("🍔"):
        st.markdown(
            "<style>div[data-testid='stPopoverButton'] button {padding:0!important;}</style>",
            unsafe_allow_html=True
        )
...
st.markdown(
    ...
    <div class="filter-bar">
        <div style="font-weight:bold; color:black;">국내 ∨</div>
        <div style="color:#1e88e5; font-weight:bold;">거래대금</div>
        <div>거래량</div>
        <div>급상승</div>
        <div>급하락</div>
    </div>
